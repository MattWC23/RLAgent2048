...
class Game():
    ...
    def move(self, direction):
        """
        Moves the game board in desired direction, updates if game is active or terminated, spawns
        in a new tile if possible, and updates the score. Returns the merged score gained by performing the move
        """
